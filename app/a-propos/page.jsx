...
export const metadata = {
  ...
  description:
    "Découvrez l'histoire et la mission de Dormesia, votre partenaire pour un sommeil de qualité et une vie équilibrée.",
};
        ...
        <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-indigo-100">
              Nous sommes une équipe passionnée d'experts dédiés à vous aider à
              retrouver un sommeil réparateur et à améliorer votre qualité de
              vie.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Dormesia est né d'une observation simple : malgré l'importance
              fondamentale du sommeil dans notre vie, beaucoup d'entre nous
              souffrent d'un sommeil de mauvaise qualité sans savoir comment y
              remédier.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Fondée en 2023 par une équipe de spécialistes du sommeil,
              nutritionnistes et psychologues, Dormesia a pour mission de
              démocratiser l'accès à l'information scientifique sur le sommeil
              et proposer des solutions concrètes et personnalisées.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Notre approche holistique combine les dernières recherches
              scientifiques avec des méthodes traditionnelles éprouvées pour
              vous offrir des conseils adaptés à votre profil unique.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Toutes nos recommandations sont basées sur des études
                  scientifiques récentes et validées par notre comité d'experts.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Nous reconnaissons que chaque personne est unique, avec des
                  besoins spécifiques qui méritent des solutions adaptées.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Nous nous efforçons de rendre l'information sur le sommeil
                  accessible à tous, dans un langage clair et avec des solutions
                  pratiques.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="bg-indigo-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Commencez dès aujourd'hui votre voyage vers un sommeil de meilleure
            qualité et une vie plus équilibrée.
          </p>
