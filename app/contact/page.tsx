        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-indigo-100">
              Vous avez des questions sur votre sommeil? Notre équipe d'experts est là pour vous aider.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300">
                Notre équipe d'experts en sommeil est disponible pour répondre à toutes vos questions et vous accompagner vers un sommeil de meilleure qualité.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">+33 1 23 45 67 89</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Lun-Ven, 9h-18h</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">contact@dormesia.com</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Réponse sous 24-48h</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">123 Avenue du Sommeil</p>
                  <p className="text-gray-700 dark:text-gray-300">75001 Paris, France</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="bg-indigo-50 dark:bg-indigo-950/30 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-2">Combien de temps avant d'observer des améliorations?</h3>
          ...
          <div className="bg-indigo-50 dark:bg-indigo-950/30 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-2">Vos conseils remplacent-ils une consultation médicale?</h3>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-indigo-50 dark:bg-indigo-950/30 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-2">Proposez-vous des consultations individuelles?</h3>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-indigo-50 dark:bg-indigo-950/30 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-2">Comment savoir quel oreiller ou matelas me convient?</h3>
            <p className="text-gray-700 dark:text-gray-300">
