...
export const metadata = {
  ...
  keywords:
    "quiz sommeil avancé, chronotype, analyse IA, troubles sommeil, Zinzino, Horne-Östberg, profil sommeil",
  openGraph: {
    title: "Quiz IA Avancé - Analyse Complète du Sommeil",
    description:
      "15 questions scientifiques pour une analyse multidimensionnelle de votre sommeil et des recommandations Zinzino personnalisées.",
    type: "website",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Quiz IA Avancé - Analyse Complète du Sommeil",
    description:
      "Découvrez votre chronotype et obtenez des recommandations Zinzino personnalisées.",
