  ...
  const features = [
    {
      ...
      description: "Des recommandations adaptées à votre profil de sommeil et à vos habitudes de vie."
    },
    {
      icon: <Sun className="h-10 w-10 text-amber-500" />,
      title: "Routines Optimales",
      description: "Découvrez les meilleures routines du matin et du soir pour un sommeil réparateur."
    },
    {
      icon: <ActivitySquare className="h-10 w-10 text-emerald-500" />,
      title: "Analyse du Sommeil",
      description: "Comprenez les différentes phases du sommeil et leur impact sur votre santé."
    },
    {
      icon: <BarChart4 className="h-10 w-10 text-purple-500" />,
      title: "Suivi des Progrès",
      description: "Suivez l'évolution de votre sommeil et identifiez les facteurs d'amélioration."
    }
  ];

  const testimonials = [
    {
      quote: "Grâce aux conseils de Dormesia, je dors enfin sans interruption. Une vraie révolution pour ma santé!",
      author: "Sophie L.",
      role: "Professeure"
    },
    {
      quote: "Le quiz m'a permis d'identifier mes problèmes de sommeil. Les recommandations sont précises et efficaces.",
      author: "Thomas M.",
      role: "Développeur"
    },
    {
      quote: "J'ai suivi les routines proposées pendant un mois et mon sommeil s'est considérablement amélioré.",
      author: "Émilie D.",
      role: "Médecin"
    }
  ];
    ...
    <div className="pt-16">
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-indigo-100">
              Dormesia vous guide vers une meilleure qualité de sommeil et une vie plus équilibrée.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Le sommeil n'est pas un luxe, c'est une nécessité biologique. Il joue un rôle crucial dans la santé physique et mentale, la consolidation de la mémoire, la régulation hormonale et le renforcement du système immunitaire.
            </p>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Chez Dormesia, nous croyons qu'un sommeil de qualité est le fondement d'une vie équilibrée et épanouie. Notre mission est de vous aider à comprendre votre sommeil et à l'améliorer.
            </p>
            <div>
      ...
      <section className="bg-indigo-50 dark:bg-indigo-950/30 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Dormesia vous accompagne dans toutes les dimensions de votre sommeil pour une vie plus épanouie et énergique.
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300">
            Explorez nos derniers articles sur le sommeil, la santé et le bien-être.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="overflow-hidden transition-all hover:shadow-lg">
            ...
            <CardContent className="p-6">
              <div className="text-sm font-medium text-indigo-600 dark:text-indigo-400 mb-2">Santé</div>
              <h3 className="text-xl font-bold mb-2">Les 4 Phases du Sommeil Expliquées</h3>
          ...
          <Card className="overflow-hidden transition-all hover:shadow-lg">
            ...
            <CardContent className="p-6">
              <div className="text-sm font-medium text-indigo-600 dark:text-indigo-400 mb-2">Bien-être</div>
              <h3 className="text-xl font-bold mb-2">5 Techniques de Méditation pour Mieux Dormir</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <Card className="overflow-hidden transition-all hover:shadow-lg">
            ...
            <CardContent className="p-6">
              <div className="text-sm font-medium text-indigo-600 dark:text-indigo-400 mb-2">Conseils</div>
              <h3 className="text-xl font-bold mb-2">L'Impact de la Musique sur la Qualité du Sommeil</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-indigo-200">
              Des témoignages de personnes qui ont amélioré leur sommeil grâce à Dormesia.
            </p>
          </div>
